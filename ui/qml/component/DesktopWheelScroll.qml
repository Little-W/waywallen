...
Item {
    ...
    // Null is intentional for the shared Cupertino wrappers: their content
    // may be either a Flickable or a plain layout.  In the latter case this
    // helper stays inert without manufacturing another scrolling surface.
